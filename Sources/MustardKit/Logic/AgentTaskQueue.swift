        ...
        tasks
            .filter {
                $0.owner == .agent
                    ...
                    && !$0.isBlocked
                    // Ledger-imported meeting work must carry the persisted Do/Don't
                    // bit. Recording-originated tasks are already locally approved.
                    && !(MeetingTaskSource.requiresAgentApproval($0.source) && !$0.agentApprovalGranted)
